...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b6:	cbea0a13          	add	s4,s4,-834 # 6370 <malloc+0x31c>
    n = write(fds[1], "x", 1);
     6ba:	00006a97          	auipc	s5,0x6
     6be:	b4ea8a93          	add	s5,s5,-1202 # 6208 <malloc+0x1b4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	c1a50513          	add	a0,a0,-998 # 6378 <malloc+0x324>
     766:	00006097          	auipc	ra,0x6
     76a:	836080e7          	jalr	-1994(ra) # 5f9c <printf>
      exit(1);
     76e:	4505                	li	a0,1
     ...
     780:	c1450513          	add	a0,a0,-1004 # 6390 <malloc+0x33c>
     784:	00006097          	auipc	ra,0x6
     788:	818080e7          	jalr	-2024(ra) # 5f9c <printf>
      exit(1);
     78c:	4505                	li	a0,1
     ...
     79a:	b9a50513          	add	a0,a0,-1126 # 6330 <malloc+0x2dc>
     79e:	00005097          	auipc	ra,0x5
     7a2:	7fe080e7          	jalr	2046(ra) # 5f9c <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     ...
     7b4:	c1050513          	add	a0,a0,-1008 # 63c0 <malloc+0x36c>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	7e4080e7          	jalr	2020(ra) # 5f9c <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     ...
     7d2:	c0a50513          	add	a0,a0,-1014 # 63d8 <malloc+0x384>
     7d6:	00005097          	auipc	ra,0x5
     7da:	7c6080e7          	jalr	1990(ra) # 5f9c <printf>
      exit(1);
     7de:	4505                	li	a0,1
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	9dc58593          	add	a1,a1,-1572 # 6200 <malloc+0x1ac>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	9b050513          	add	a0,a0,-1616 # 61f0 <malloc+0x19c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	98450513          	add	a0,a0,-1660 # 61f0 <malloc+0x19c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	97050513          	add	a0,a0,-1680 # 61f0 <malloc+0x19c>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	baa58593          	add	a1,a1,-1110 # 6468 <malloc+0x414>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	8f050513          	add	a0,a0,-1808 # 61f0 <malloc+0x19c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	ac450513          	add	a0,a0,-1340 # 6408 <malloc+0x3b4>
     94c:	00005097          	auipc	ra,0x5
     950:	650080e7          	jalr	1616(ra) # 5f9c <printf>
    exit(1);
     954:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	ac850513          	add	a0,a0,-1336 # 6428 <malloc+0x3d4>
     968:	00005097          	auipc	ra,0x5
     96c:	634080e7          	jalr	1588(ra) # 5f9c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	ac450513          	add	a0,a0,-1340 # 6438 <malloc+0x3e4>
     97c:	00005097          	auipc	ra,0x5
     980:	620080e7          	jalr	1568(ra) # 5f9c <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	ac850513          	add	a0,a0,-1336 # 6458 <malloc+0x404>
     998:	00005097          	auipc	ra,0x5
     99c:	604080e7          	jalr	1540(ra) # 5f9c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a9450513          	add	a0,a0,-1388 # 6438 <malloc+0x3e4>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	5f0080e7          	jalr	1520(ra) # 5f9c <printf>
    exit(1);
     9b4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	aae50513          	add	a0,a0,-1362 # 6470 <malloc+0x41c>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	5d2080e7          	jalr	1490(ra) # 5f9c <printf>
    exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	ab050513          	add	a0,a0,-1360 # 6490 <malloc+0x43c>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	5b4080e7          	jalr	1460(ra) # 5f9c <printf>
    exit(1);
     9f0:	4505                	li	a0,1
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a9c50513          	add	a0,a0,-1380 # 64b0 <malloc+0x45c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	aac98993          	add	s3,s3,-1364 # 64d8 <malloc+0x484>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	adca8a93          	add	s5,s5,-1316 # 6510 <malloc+0x4bc>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	a3650513          	add	a0,a0,-1482 # 64b0 <malloc+0x45c>
  ...
  if(unlink("small") < 0){
     ...
     aba:	9fa50513          	add	a0,a0,-1542 # 64b0 <malloc+0x45c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	9d850513          	add	a0,a0,-1576 # 64b8 <malloc+0x464>
     ae8:	00005097          	auipc	ra,0x5
     aec:	4b4080e7          	jalr	1204(ra) # 5f9c <printf>
    exit(1);
     af0:	4505                	li	a0,1
     ...
     b02:	9ea50513          	add	a0,a0,-1558 # 64e8 <malloc+0x494>
     b06:	00005097          	auipc	ra,0x5
     b0a:	496080e7          	jalr	1174(ra) # 5f9c <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     ...
     b20:	a0450513          	add	a0,a0,-1532 # 6520 <malloc+0x4cc>
     b24:	00005097          	auipc	ra,0x5
     b28:	478080e7          	jalr	1144(ra) # 5f9c <printf>
      exit(1);
     b2c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	a1050513          	add	a0,a0,-1520 # 6548 <malloc+0x4f4>
     b40:	00005097          	auipc	ra,0x5
     b44:	45c080e7          	jalr	1116(ra) # 5f9c <printf>
    exit(1);
     b48:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	a1450513          	add	a0,a0,-1516 # 6568 <malloc+0x514>
     b5c:	00005097          	auipc	ra,0x5
     b60:	440080e7          	jalr	1088(ra) # 5f9c <printf>
    exit(1);
     b64:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	a1050513          	add	a0,a0,-1520 # 6580 <malloc+0x52c>
     b78:	00005097          	auipc	ra,0x5
     b7c:	424080e7          	jalr	1060(ra) # 5f9c <printf>
    exit(1);
     b80:	4505                	li	a0,1
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9fe50513          	add	a0,a0,-1538 # 65a0 <malloc+0x54c>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	9ac50513          	add	a0,a0,-1620 # 65a0 <malloc+0x54c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	96c50513          	add	a0,a0,-1684 # 65a8 <malloc+0x554>
     c44:	00005097          	auipc	ra,0x5
     c48:	358080e7          	jalr	856(ra) # 5f9c <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5e:	96e50513          	add	a0,a0,-1682 # 65c8 <malloc+0x574>
     c62:	00005097          	auipc	ra,0x5
     c66:	33a080e7          	jalr	826(ra) # 5f9c <printf>
      exit(1);
     c6a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	97a50513          	add	a0,a0,-1670 # 65f0 <malloc+0x59c>
     c7e:	00005097          	auipc	ra,0x5
     c82:	31e080e7          	jalr	798(ra) # 5f9c <printf>
    exit(1);
     c86:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca6:	8fe50513          	add	a0,a0,-1794 # 65a0 <malloc+0x54c>
     ...
     cd2:	94250513          	add	a0,a0,-1726 # 6610 <malloc+0x5bc>
     cd6:	00005097          	auipc	ra,0x5
     cda:	2c6080e7          	jalr	710(ra) # 5f9c <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ...
     cf0:	94c50513          	add	a0,a0,-1716 # 6638 <malloc+0x5e4>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	2a8080e7          	jalr	680(ra) # 5f9c <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     ...
     d0e:	94650513          	add	a0,a0,-1722 # 6650 <malloc+0x5fc>
     d12:	00005097          	auipc	ra,0x5
     d16:	28a080e7          	jalr	650(ra) # 5f9c <printf>
      exit(1);
     d1a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	95250513          	add	a0,a0,-1710 # 6678 <malloc+0x624>
     d2e:	00005097          	auipc	ra,0x5
     d32:	26e080e7          	jalr	622(ra) # 5f9c <printf>
    exit(1);
     d36:	4505                	li	a0,1
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	93c50513          	add	a0,a0,-1732 # 6690 <malloc+0x63c>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	95458593          	add	a1,a1,-1708 # 66c0 <malloc+0x66c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	90850513          	add	a0,a0,-1784 # 6690 <malloc+0x63c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	8f250513          	add	a0,a0,-1806 # 6690 <malloc+0x63c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	8dc50513          	add	a0,a0,-1828 # 6690 <malloc+0x63c>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	94058593          	add	a1,a1,-1728 # 6708 <malloc+0x6b4>
  ...
  unlink("unlinkread");
     ...
     e34:	86050513          	add	a0,a0,-1952 # 6690 <malloc+0x63c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	85050513          	add	a0,a0,-1968 # 66a0 <malloc+0x64c>
     e58:	00005097          	auipc	ra,0x5
     e5c:	144080e7          	jalr	324(ra) # 5f9c <printf>
    exit(1);
     e60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	85c50513          	add	a0,a0,-1956 # 66c8 <malloc+0x674>
     e74:	00005097          	auipc	ra,0x5
     e78:	128080e7          	jalr	296(ra) # 5f9c <printf>
    exit(1);
     e7c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	86050513          	add	a0,a0,-1952 # 66e8 <malloc+0x694>
     e90:	00005097          	auipc	ra,0x5
     e94:	10c080e7          	jalr	268(ra) # 5f9c <printf>
    exit(1);
     e98:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	86c50513          	add	a0,a0,-1940 # 6710 <malloc+0x6bc>
     eac:	00005097          	auipc	ra,0x5
     eb0:	0f0080e7          	jalr	240(ra) # 5f9c <printf>
    exit(1);
     eb4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	87050513          	add	a0,a0,-1936 # 6730 <malloc+0x6dc>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	0d4080e7          	jalr	212(ra) # 5f9c <printf>
    exit(1);
     ed0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	87450513          	add	a0,a0,-1932 # 6750 <malloc+0x6fc>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	0b8080e7          	jalr	184(ra) # 5f9c <printf>
    exit(1);
     eec:	4505                	li	a0,1
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	78058593          	add	a1,a1,1920 # 66c0 <malloc+0x66c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	81858593          	add	a1,a1,-2024 # 6778 <malloc+0x724>
     f68:	00006517          	auipc	a0,0x6
     f6c:	80850513          	add	a0,a0,-2040 # 6770 <malloc+0x71c>
  ...
  unlink("lf1");
     ...
     f80:	7f450513          	add	a0,a0,2036 # 6770 <malloc+0x71c>
     f84:	00005097          	auipc	ra,0x5
     f88:	cf8080e7          	jalr	-776(ra) # 5c7c <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	7e250513          	add	a0,a0,2018 # 6770 <malloc+0x71c>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	7d450513          	add	a0,a0,2004 # 6778 <malloc+0x724>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	79c58593          	add	a1,a1,1948 # 6778 <malloc+0x724>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	78650513          	add	a0,a0,1926 # 6778 <malloc+0x724>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c82080e7          	jalr	-894(ra) # 5c7c <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	76e58593          	add	a1,a1,1902 # 6770 <malloc+0x71c>
    100a:	00005517          	auipc	a0,0x5
    100e:	76e50513          	add	a0,a0,1902 # 6778 <malloc+0x724>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	75258593          	add	a1,a1,1874 # 6770 <malloc+0x71c>
    1026:	00006517          	auipc	a0,0x6
    102a:	85a50513          	add	a0,a0,-1958 # 6880 <malloc+0x82c>
    ...
    104c:	73850513          	add	a0,a0,1848 # 6780 <malloc+0x72c>
    1050:	00005097          	auipc	ra,0x5
    1054:	f4c080e7          	jalr	-180(ra) # 5f9c <printf>
    exit(1);
    1058:	4505                	li	a0,1
    ...
    1068:	73450513          	add	a0,a0,1844 # 6798 <malloc+0x744>
    106c:	00005097          	auipc	ra,0x5
    1070:	f30080e7          	jalr	-208(ra) # 5f9c <printf>
    exit(1);
    1074:	4505                	li	a0,1
    ...
    1084:	73050513          	add	a0,a0,1840 # 67b0 <malloc+0x75c>
    1088:	00005097          	auipc	ra,0x5
    108c:	f14080e7          	jalr	-236(ra) # 5f9c <printf>
    exit(1);
    1090:	4505                	li	a0,1
    ...
    10a0:	73450513          	add	a0,a0,1844 # 67d0 <malloc+0x77c>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	ef8080e7          	jalr	-264(ra) # 5f9c <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    ...
    10bc:	74850513          	add	a0,a0,1864 # 6800 <malloc+0x7ac>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	edc080e7          	jalr	-292(ra) # 5f9c <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    ...
    10d8:	74450513          	add	a0,a0,1860 # 6818 <malloc+0x7c4>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	ec0080e7          	jalr	-320(ra) # 5f9c <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    ...
    10f4:	74050513          	add	a0,a0,1856 # 6830 <malloc+0x7dc>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	ea4080e7          	jalr	-348(ra) # 5f9c <printf>
    exit(1);
    1100:	4505                	li	a0,1
    ...
    1110:	74c50513          	add	a0,a0,1868 # 6858 <malloc+0x804>
    1114:	00005097          	auipc	ra,0x5
    1118:	e88080e7          	jalr	-376(ra) # 5f9c <printf>
    exit(1);
    111c:	4505                	li	a0,1
    ...
    112c:	76050513          	add	a0,a0,1888 # 6888 <malloc+0x834>
    1130:	00005097          	auipc	ra,0x5
    1134:	e6c080e7          	jalr	-404(ra) # 5f9c <printf>
    exit(1);
    1138:	4505                	li	a0,1
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	74e98993          	add	s3,s3,1870 # 68a8 <malloc+0x854>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	72250513          	add	a0,a0,1826 # 68b8 <malloc+0x864>
    119e:	00005097          	auipc	ra,0x5
    11a2:	dfe080e7          	jalr	-514(ra) # 5f9c <printf>
      exit(1);
    11a6:	4505                	li	a0,1
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	6dca0a13          	add	s4,s4,1756 # 68d8 <malloc+0x884>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	68a50513          	add	a0,a0,1674 # 68d8 <malloc+0x884>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	62250513          	add	a0,a0,1570 # 68e0 <malloc+0x88c>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	cd6080e7          	jalr	-810(ra) # 5f9c <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    ...
    12e2:	62250513          	add	a0,a0,1570 # 6900 <malloc+0x8ac>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	cb6080e7          	jalr	-842(ra) # 5f9c <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    ...
    12fe:	62650513          	add	a0,a0,1574 # 6920 <malloc+0x8cc>
    1302:	00005097          	auipc	ra,0x5
    1306:	c9a080e7          	jalr	-870(ra) # 5f9c <printf>
      exit(1);
    130a:	4505                	li	a0,1
...
000000000000134c <badarg>:
{
    ...
    136a:	e3298993          	add	s3,s3,-462 # 6198 <malloc+0x144>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	78878793          	add	a5,a5,1928 # 7b78 <malloc+0x1b24>
  ...
  if(pid == 0){
    ...
    1450:	17478793          	add	a5,a5,372 # 85c0 <malloc+0x256c>
    ...
    1474:	d2850513          	add	a0,a0,-728 # 6198 <malloc+0x144>
    ...
    148c:	54050513          	add	a0,a0,1344 # 69c8 <malloc+0x974>
    1490:	00005097          	auipc	ra,0x5
    1494:	b0c080e7          	jalr	-1268(ra) # 5f9c <printf>
      exit(1);
    1498:	4505                	li	a0,1
    ...
    14ac:	49850513          	add	a0,a0,1176 # 6940 <malloc+0x8ec>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	aec080e7          	jalr	-1300(ra) # 5f9c <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    ...
    14cc:	49850513          	add	a0,a0,1176 # 6960 <malloc+0x90c>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	acc080e7          	jalr	-1332(ra) # 5f9c <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    ...
    14ee:	49650513          	add	a0,a0,1174 # 6980 <malloc+0x92c>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	aaa080e7          	jalr	-1366(ra) # 5f9c <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    ...
    150e:	49e50513          	add	a0,a0,1182 # 69a8 <malloc+0x954>
    1512:	00005097          	auipc	ra,0x5
    1516:	a8a080e7          	jalr	-1398(ra) # 5f9c <printf>
    exit(1);
    151a:	4505                	li	a0,1
    ...
    1528:	90450513          	add	a0,a0,-1788 # 6e28 <malloc+0xdd4>
    152c:	00005097          	auipc	ra,0x5
    1530:	a70080e7          	jalr	-1424(ra) # 5f9c <printf>
    exit(1);
    1534:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1572:	48250513          	add	a0,a0,1154 # 69f0 <malloc+0x99c>
    1576:	00005097          	auipc	ra,0x5
    157a:	a26080e7          	jalr	-1498(ra) # 5f9c <printf>
    exit(1);
    157e:	4505                	li	a0,1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159c:	c5850513          	add	a0,a0,-936 # 61f0 <malloc+0x19c>
  ...
  if(pid == 0){
    ...
    15ce:	c26a0a13          	add	s4,s4,-986 # 61f0 <malloc+0x19c>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	47ea8a93          	add	s5,s5,1150 # 6a50 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    164e:	3d650513          	add	a0,a0,982 # 6a20 <malloc+0x9cc>
    1652:	00005097          	auipc	ra,0x5
    1656:	94a080e7          	jalr	-1718(ra) # 5f9c <printf>
    exit(1);
    165a:	4505                	li	a0,1
    ...
    166a:	3d250513          	add	a0,a0,978 # 6a38 <malloc+0x9e4>
    166e:	00005097          	auipc	ra,0x5
    1672:	92e080e7          	jalr	-1746(ra) # 5f9c <printf>
        exit(1);
    1676:	4505                	li	a0,1
    ...
    1688:	3dc50513          	add	a0,a0,988 # 6a60 <malloc+0xa0c>
    168c:	00005097          	auipc	ra,0x5
    1690:	910080e7          	jalr	-1776(ra) # 5f9c <printf>
        exit(1);
    1694:	4505                	li	a0,1
    ...
    16ae:	b46a0a13          	add	s4,s4,-1210 # 61f0 <malloc+0x19c>
    int n = write(fd, "xxx", 3);
    16b2:	00005a97          	auipc	s5,0x5
    16b6:	3cea8a93          	add	s5,s5,974 # 6a80 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1700:	af450513          	add	a0,a0,-1292 # 61f0 <malloc+0x19c>
  ...
  exit(xstatus);
    ...
    171e:	31e50513          	add	a0,a0,798 # 6a38 <malloc+0x9e4>
    1722:	00005097          	auipc	ra,0x5
    1726:	87a080e7          	jalr	-1926(ra) # 5f9c <printf>
      exit(1);
    172a:	4505                	li	a0,1
    ...
    173c:	35050513          	add	a0,a0,848 # 6a88 <malloc+0xa34>
    1740:	00005097          	auipc	ra,0x5
    1744:	85c080e7          	jalr	-1956(ra) # 5f9c <printf>
      exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1762:	a3a78793          	add	a5,a5,-1478 # 6198 <malloc+0x144>
    1766:	fcf43023          	sd	a5,-64(s0)
    176a:	00005797          	auipc	a5,0x5
    176e:	33e78793          	add	a5,a5,830 # 6aa8 <malloc+0xa54>
    1772:	fcf43423          	sd	a5,-56(s0)
    1776:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    177a:	00005517          	auipc	a0,0x5
    177e:	33650513          	add	a0,a0,822 # 6ab0 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    17ae:	30650513          	add	a0,a0,774 # 6ab0 <malloc+0xa5c>
    ...
    17ca:	30a50513          	add	a0,a0,778 # 6ad0 <malloc+0xa7c>
    17ce:	00004097          	auipc	ra,0x4
    17d2:	7ce080e7          	jalr	1998(ra) # 5f9c <printf>
      exit(1);
    17d6:	4505                	li	a0,1
    ...
    17e8:	23c50513          	add	a0,a0,572 # 6a20 <malloc+0x9cc>
    17ec:	00004097          	auipc	ra,0x4
    17f0:	7b0080e7          	jalr	1968(ra) # 5f9c <printf>
     exit(1);
    17f4:	4505                	li	a0,1
    ...
    1804:	2b850513          	add	a0,a0,696 # 6ab8 <malloc+0xa64>
    1808:	00004097          	auipc	ra,0x4
    180c:	794080e7          	jalr	1940(ra) # 5f9c <printf>
      exit(1);
    1810:	4505                	li	a0,1
    ...
    1822:	97a50513          	add	a0,a0,-1670 # 6198 <malloc+0x144>
  ...
  if(xstatus != 0)
    ...
    1856:	28e50513          	add	a0,a0,654 # 6ae0 <malloc+0xa8c>
    185a:	00004097          	auipc	ra,0x4
    185e:	742080e7          	jalr	1858(ra) # 5f9c <printf>
      exit(1);
    1862:	4505                	li	a0,1
    ...
    1872:	28a50513          	add	a0,a0,650 # 6af8 <malloc+0xaa4>
    1876:	00004097          	auipc	ra,0x4
    187a:	726080e7          	jalr	1830(ra) # 5f9c <printf>
    187e:	b7d1                	j	1842 <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    1880:	4581                	li	a1,0
    1882:	00005517          	auipc	a0,0x5
    1886:	22e50513          	add	a0,a0,558 # 6ab0 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18b0:	cbc50513          	add	a0,a0,-836 # 6568 <malloc+0x514>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	6e8080e7          	jalr	1768(ra) # 5f9c <printf>
    exit(1);
    18bc:	4505                	li	a0,1
    ...
    18cc:	17050513          	add	a0,a0,368 # 6a38 <malloc+0x9e4>
    18d0:	00004097          	auipc	ra,0x4
    18d4:	6cc080e7          	jalr	1740(ra) # 5f9c <printf>
    exit(1);
    18d8:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18e6:	1ce50513          	add	a0,a0,462 # 6ab0 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1910:	20450513          	add	a0,a0,516 # 6b10 <malloc+0xabc>
    1914:	00004097          	auipc	ra,0x4
    1918:	688080e7          	jalr	1672(ra) # 5f9c <printf>
    exit(1);
    191c:	4505                	li	a0,1
...
0000000000001930 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d8:	15450513          	add	a0,a0,340 # 6b28 <malloc+0xad4>
    19dc:	00004097          	auipc	ra,0x4
    19e0:	5c0080e7          	jalr	1472(ra) # 5f9c <printf>
    exit(1);
    19e4:	4505                	li	a0,1
    ...
    1a1a:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a66:	0de50513          	add	a0,a0,222 # 6b40 <malloc+0xaec>
    1a6a:	00004097          	auipc	ra,0x4
    1a6e:	532080e7          	jalr	1330(ra) # 5f9c <printf>
        exit(1);
    1a72:	4505                	li	a0,1
    ...
    1a82:	0da50513          	add	a0,a0,218 # 6b58 <malloc+0xb04>
    1a86:	00004097          	auipc	ra,0x4
    1a8a:	516080e7          	jalr	1302(ra) # 5f9c <printf>
          return;
    ...
    1ab4:	0c050513          	add	a0,a0,192 # 6b70 <malloc+0xb1c>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	4e4080e7          	jalr	1252(ra) # 5f9c <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1b00:	09450513          	add	a0,a0,148 # 6b90 <malloc+0xb3c>
    1b04:	00004097          	auipc	ra,0x4
    1b08:	498080e7          	jalr	1176(ra) # 5f9c <printf>
    exit(1);
    1b0c:	4505                	li	a0,1
...
0000000000001b16 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b72:	eb250513          	add	a0,a0,-334 # 6a20 <malloc+0x9cc>
    1b76:	00004097          	auipc	ra,0x4
    1b7a:	426080e7          	jalr	1062(ra) # 5f9c <printf>
      exit(1);
    1b7e:	4505                	li	a0,1
    ...
    1b8e:	01e50513          	add	a0,a0,30 # 6ba8 <malloc+0xb54>
    1b92:	00004097          	auipc	ra,0x4
    1b96:	40a080e7          	jalr	1034(ra) # 5f9c <printf>
        exit(1);
    1b9a:	4505                	li	a0,1
    ...
    1baa:	01a50513          	add	a0,a0,26 # 6bc0 <malloc+0xb6c>
    1bae:	00004097          	auipc	ra,0x4
    1bb2:	3ee080e7          	jalr	1006(ra) # 5f9c <printf>
        exit(1);
    1bb6:	4505                	li	a0,1
...
0000000000001bca <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c22:	e0250513          	add	a0,a0,-510 # 6a20 <malloc+0x9cc>
    1c26:	00004097          	auipc	ra,0x4
    1c2a:	376080e7          	jalr	886(ra) # 5f9c <printf>
      exit(1);
    1c2e:	4505                	li	a0,1
    ...
    1c46:	dde50513          	add	a0,a0,-546 # 6a20 <malloc+0x9cc>
    1c4a:	00004097          	auipc	ra,0x4
    1c4e:	352080e7          	jalr	850(ra) # 5f9c <printf>
        exit(1);
    1c52:	4505                	li	a0,1
...
0000000000001c64 <forkfork>:
{
    ...
    1cc0:	f2450513          	add	a0,a0,-220 # 6be0 <malloc+0xb8c>
    1cc4:	00004097          	auipc	ra,0x4
    1cc8:	2d8080e7          	jalr	728(ra) # 5f9c <printf>
      exit(1);
    1ccc:	4505                	li	a0,1
    ...
    1cd2:	f5e080e7          	jalr	-162(ra) # 5c2c <exit>
{
    ...
    1d18:	edc50513          	add	a0,a0,-292 # 6bf0 <malloc+0xb9c>
    1d1c:	00004097          	auipc	ra,0x4
    1d20:	280080e7          	jalr	640(ra) # 5f9c <printf>
      exit(1);
    1d24:	4505                	li	a0,1
...
0000000000001d2e <reparent2>:
{
  ...
  exit(0);
    ...
    1d66:	0c650513          	add	a0,a0,198 # 6e28 <malloc+0xdd4>
    1d6a:	00004097          	auipc	ra,0x4
    1d6e:	232080e7          	jalr	562(ra) # 5f9c <printf>
      exit(1);
    1d72:	4505                	li	a0,1
...
0000000000001d96 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e04:	02850513          	add	a0,a0,40 # 6e28 <malloc+0xdd4>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	194080e7          	jalr	404(ra) # 5f9c <printf>
      exit(1);
    1e10:	4505                	li	a0,1
    ...
    1e30:	c8c50513          	add	a0,a0,-884 # 6ab8 <malloc+0xa64>
    1e34:	00004097          	auipc	ra,0x4
    1e38:	168080e7          	jalr	360(ra) # 5f9c <printf>
          exit(1);
    1e3c:	4505                	li	a0,1
    ...
    1ea2:	d7250513          	add	a0,a0,-654 # 6c10 <malloc+0xbbc>
    1ea6:	00004097          	auipc	ra,0x4
    1eaa:	0f6080e7          	jalr	246(ra) # 5f9c <printf>
            exit(1);
    1eae:	4505                	li	a0,1
    ...
    1ed6:	d5650513          	add	a0,a0,-682 # 6c28 <malloc+0xbd4>
    1eda:	00004097          	auipc	ra,0x4
    1ede:	0c2080e7          	jalr	194(ra) # 5f9c <printf>
        exit(1);
    1ee2:	4505                	li	a0,1
    ...
    1f38:	d1c50513          	add	a0,a0,-740 # 6c50 <malloc+0xbfc>
    1f3c:	00004097          	auipc	ra,0x4
    1f40:	060080e7          	jalr	96(ra) # 5f9c <printf>
        exit(1);
    1f44:	4505                	li	a0,1
...
0000000000001fbc <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fdc:	23050513          	add	a0,a0,560 # 6208 <malloc+0x1b4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2018:	1f4b0b13          	add	s6,s6,500 # 6208 <malloc+0x1b4>
      link("cat", "x");
    201c:	00005c17          	auipc	s8,0x5
    2020:	c5cc0c13          	add	s8,s8,-932 # 6c78 <malloc+0xc24>
    2024:	a825                	j	205c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2026:	85a6                	mv	a1,s1
    2028:	00005517          	auipc	a0,0x5
    202c:	9f850513          	add	a0,a0,-1544 # 6a20 <malloc+0x9cc>
    2030:	00004097          	auipc	ra,0x4
    2034:	f6c080e7          	jalr	-148(ra) # 5f9c <printf>
    exit(1);
    2038:	4505                	li	a0,1
...
00000000000020c0 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20f0:	bdc50513          	add	a0,a0,-1060 # 6cc8 <malloc+0xc74>
    20f4:	00004097          	auipc	ra,0x4
    20f8:	ea8080e7          	jalr	-344(ra) # 5f9c <printf>
    exit(1);
    20fc:	4505                	li	a0,1
    ...
    2114:	b7050513          	add	a0,a0,-1168 # 6c80 <malloc+0xc2c>
    2118:	00004097          	auipc	ra,0x4
    211c:	e84080e7          	jalr	-380(ra) # 5f9c <printf>
    exit(1);
    2120:	4505                	li	a0,1
    ...
    2130:	b6c50513          	add	a0,a0,-1172 # 6c98 <malloc+0xc44>
    2134:	00004097          	auipc	ra,0x4
    2138:	e68080e7          	jalr	-408(ra) # 5f9c <printf>
      exit(1);
    213c:	4505                	li	a0,1
    ...
    214c:	b6850513          	add	a0,a0,-1176 # 6cb0 <malloc+0xc5c>
    2150:	00004097          	auipc	ra,0x4
    2154:	e4c080e7          	jalr	-436(ra) # 5f9c <printf>
    exit(1);
    2158:	4505                	li	a0,1
...
0000000000002198 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2202:	82250513          	add	a0,a0,-2014 # 6a20 <malloc+0x9cc>
    2206:	00004097          	auipc	ra,0x4
    220a:	d96080e7          	jalr	-618(ra) # 5f9c <printf>
      exit(1);
    220e:	4505                	li	a0,1
    ...
    2224:	ad050513          	add	a0,a0,-1328 # 6cf0 <malloc+0xc9c>
    2228:	00004097          	auipc	ra,0x4
    222c:	d74080e7          	jalr	-652(ra) # 5f9c <printf>
      exit(1);
    2230:	4505                	li	a0,1
...
0000000000002244 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a6:	77e50513          	add	a0,a0,1918 # 6a20 <malloc+0x9cc>
    22aa:	00004097          	auipc	ra,0x4
    22ae:	cf2080e7          	jalr	-782(ra) # 5f9c <printf>
      exit(1);
    22b2:	4505                	li	a0,1
    ...
    22d2:	a4250513          	add	a0,a0,-1470 # 6d10 <malloc+0xcbc>
    22d6:	00004097          	auipc	ra,0x4
    22da:	cc6080e7          	jalr	-826(ra) # 5f9c <printf>
      exit(1);
    22de:	4505                	li	a0,1
...
00000000000022f2 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2302:	a2a50513          	add	a0,a0,-1494 # 6d28 <malloc+0xcd4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2334:	9f850513          	add	a0,a0,-1544 # 6d28 <malloc+0xcd4>
  ...
  close(fd);
    ...
    236a:	9d270713          	add	a4,a4,-1582 # 6d38 <malloc+0xce4>
    ...
    23be:	a5e50513          	add	a0,a0,-1442 # 6e18 <malloc+0xdc4>
    23c2:	00004097          	auipc	ra,0x4
    23c6:	bda080e7          	jalr	-1062(ra) # 5f9c <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23e2:	a5a50513          	add	a0,a0,-1446 # 6e38 <malloc+0xde4>
    23e6:	00004097          	auipc	ra,0x4
    23ea:	bb6080e7          	jalr	-1098(ra) # 5f9c <printf>
    exit(1);
    23ee:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2440:	a1c50513          	add	a0,a0,-1508 # 6e58 <malloc+0xe04>
    2444:	00004097          	auipc	ra,0x4
    2448:	b58080e7          	jalr	-1192(ra) # 5f9c <printf>
    exit(1);
    244c:	4505                	li	a0,1
    ...
    245c:	5c850513          	add	a0,a0,1480 # 6a20 <malloc+0x9cc>
    2460:	00004097          	auipc	ra,0x4
    2464:	b3c080e7          	jalr	-1220(ra) # 5f9c <printf>
    exit(1);
    2468:	4505                	li	a0,1
...
000000000000247c <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24ca:	55a50513          	add	a0,a0,1370 # 6a20 <malloc+0x9cc>
    24ce:	00004097          	auipc	ra,0x4
    24d2:	ace080e7          	jalr	-1330(ra) # 5f9c <printf>
    exit(1);
    24d6:	4505                	li	a0,1
...
00000000000024ea <manywrites>:
{
  ...
  exit(0);
    ...
    254e:	8de50513          	add	a0,a0,-1826 # 6e28 <malloc+0xdd4>
    2552:	00004097          	auipc	ra,0x4
    2556:	a4a080e7          	jalr	-1462(ra) # 5f9c <printf>
      exit(1);
    255a:	4505                	li	a0,1
    ...
    2604:	88050513          	add	a0,a0,-1920 # 6e80 <malloc+0xe2c>
    2608:	00004097          	auipc	ra,0x4
    260c:	994080e7          	jalr	-1644(ra) # 5f9c <printf>
            exit(1);
    2610:	4505                	li	a0,1
    ...
    2624:	c4850513          	add	a0,a0,-952 # 6268 <malloc+0x214>
    2628:	00004097          	auipc	ra,0x4
    262c:	974080e7          	jalr	-1676(ra) # 5f9c <printf>
            exit(1);
    2630:	4505                	li	a0,1
...
0000000000002642 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26bc:	4c078793          	add	a5,a5,1216 # 7b78 <malloc+0x1b24>
  ...
  if(ret != -1){
    ...
    26fe:	79e50513          	add	a0,a0,1950 # 6e98 <malloc+0xe44>
    2702:	00004097          	auipc	ra,0x4
    2706:	89a080e7          	jalr	-1894(ra) # 5f9c <printf>
    exit(1);
    270a:	4505                	li	a0,1
    ...
    271c:	22850513          	add	a0,a0,552 # 6940 <malloc+0x8ec>
    2720:	00004097          	auipc	ra,0x4
    2724:	87c080e7          	jalr	-1924(ra) # 5f9c <printf>
    exit(1);
    2728:	4505                	li	a0,1
    ...
    273a:	22a50513          	add	a0,a0,554 # 6960 <malloc+0x90c>
    273e:	00004097          	auipc	ra,0x4
    2742:	85e080e7          	jalr	-1954(ra) # 5f9c <printf>
    exit(1);
    2746:	4505                	li	a0,1
    ...
    275a:	22a50513          	add	a0,a0,554 # 6980 <malloc+0x92c>
    275e:	00004097          	auipc	ra,0x4
    2762:	83e080e7          	jalr	-1986(ra) # 5f9c <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2778:	23450513          	add	a0,a0,564 # 69a8 <malloc+0x954>
    277c:	00004097          	auipc	ra,0x4
    2780:	820080e7          	jalr	-2016(ra) # 5f9c <printf>
    exit(1);
    2784:	4505                	li	a0,1
...
000000000000278e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c4:	71850513          	add	a0,a0,1816 # 6ed8 <malloc+0xe84>
  ...
  if(n >= 0){
    ...
    27f4:	70850513          	add	a0,a0,1800 # 6ef8 <malloc+0xea4>
    27f8:	00003097          	auipc	ra,0x3
    27fc:	7a4080e7          	jalr	1956(ra) # 5f9c <printf>
    exit(1);
    2800:	4505                	li	a0,1
    ...
    2812:	69250513          	add	a0,a0,1682 # 6ea0 <malloc+0xe4c>
    2816:	00003097          	auipc	ra,0x3
    281a:	786080e7          	jalr	1926(ra) # 5f9c <printf>
    exit(1);
    281e:	4505                	li	a0,1
    ...
    282e:	68e50513          	add	a0,a0,1678 # 6eb8 <malloc+0xe64>
    2832:	00003097          	auipc	ra,0x3
    2836:	76a080e7          	jalr	1898(ra) # 5f9c <printf>
    exit(1);
    283a:	4505                	li	a0,1
    ...
    2848:	69c50513          	add	a0,a0,1692 # 6ee0 <malloc+0xe8c>
    284c:	00003097          	auipc	ra,0x3
    2850:	750080e7          	jalr	1872(ra) # 5f9c <printf>
    exit(1);
    2854:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    28a8:	68450513          	add	a0,a0,1668 # 6f28 <malloc+0xed4>
    28ac:	00003097          	auipc	ra,0x3
    28b0:	6f0080e7          	jalr	1776(ra) # 5f9c <printf>
    exit(1);
    28b4:	4505                	li	a0,1
    ...
    28c2:	62250513          	add	a0,a0,1570 # 6ee0 <malloc+0xe8c>
    28c6:	00003097          	auipc	ra,0x3
    28ca:	6d6080e7          	jalr	1750(ra) # 5f9c <printf>
    exit(1);
    28ce:	4505                	li	a0,1
...
00000000000028ec <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2948:	60c50513          	add	a0,a0,1548 # 6f50 <malloc+0xefc>
    294c:	00003097          	auipc	ra,0x3
    2950:	650080e7          	jalr	1616(ra) # 5f9c <printf>
    exit(1);
    2954:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    29ac:	5c850513          	add	a0,a0,1480 # 6f70 <malloc+0xf1c>
    29b0:	00003097          	auipc	ra,0x3
    29b4:	5ec080e7          	jalr	1516(ra) # 5f9c <printf>
    exit(1);
    29b8:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2a10:	5c450513          	add	a0,a0,1476 # 6fd0 <malloc+0xf7c>
    2a14:	00003097          	auipc	ra,0x3
    2a18:	588080e7          	jalr	1416(ra) # 5f9c <printf>
    exit(1);
    2a1c:	4505                	li	a0,1
    ...
    2a32:	56250513          	add	a0,a0,1378 # 6f90 <malloc+0xf3c>
    2a36:	00003097          	auipc	ra,0x3
    2a3a:	566080e7          	jalr	1382(ra) # 5f9c <printf>
      exit(1);
    2a3e:	4505                	li	a0,1
    ...
    2a4e:	56650513          	add	a0,a0,1382 # 6fb0 <malloc+0xf5c>
    2a52:	00003097          	auipc	ra,0x3
    2a56:	54a080e7          	jalr	1354(ra) # 5f9c <printf>
    exit(1);
    2a5a:	4505                	li	a0,1
...
0000000000002a8a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b98:	45c50513          	add	a0,a0,1116 # 6ff0 <malloc+0xf9c>
    2b9c:	00003097          	auipc	ra,0x3
    2ba0:	400080e7          	jalr	1024(ra) # 5f9c <printf>
    exit(1);
    2ba4:	4505                	li	a0,1
    ...
    2bb4:	48850513          	add	a0,a0,1160 # 7038 <malloc+0xfe4>
    2bb8:	00003097          	auipc	ra,0x3
    2bbc:	3e4080e7          	jalr	996(ra) # 5f9c <printf>
    exit(1);
    2bc0:	4505                	li	a0,1
    ...
    2bd4:	48850513          	add	a0,a0,1160 # 7058 <malloc+0x1004>
    2bd8:	00003097          	auipc	ra,0x3
    2bdc:	3c4080e7          	jalr	964(ra) # 5f9c <printf>
    exit(1);
    2be0:	4505                	li	a0,1
    ...
    2bf4:	4a850513          	add	a0,a0,1192 # 7098 <malloc+0x1044>
    2bf8:	00003097          	auipc	ra,0x3
    2bfc:	3a4080e7          	jalr	932(ra) # 5f9c <printf>
    exit(1);
    2c00:	4505                	li	a0,1
    ...
    2c10:	4bc50513          	add	a0,a0,1212 # 70c8 <malloc+0x1074>
    2c14:	00003097          	auipc	ra,0x3
    2c18:	388080e7          	jalr	904(ra) # 5f9c <printf>
    exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c30:	4d450513          	add	a0,a0,1236 # 7100 <malloc+0x10ac>
    2c34:	00003097          	auipc	ra,0x3
    2c38:	368080e7          	jalr	872(ra) # 5f9c <printf>
    exit(1);
    2c3c:	4505                	li	a0,1
...
0000000000002c46 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c6a:	4c250513          	add	a0,a0,1218 # 7128 <malloc+0x10d4>
    2c6e:	00003097          	auipc	ra,0x3
    2c72:	ffe080e7          	jalr	-2(ra) # 5c6c <open>
    2c76:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c78:	00004517          	auipc	a0,0x4
    2c7c:	4b050513          	add	a0,a0,1200 # 7128 <malloc+0x10d4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cd0:	46450513          	add	a0,a0,1124 # 7130 <malloc+0x10dc>
    2cd4:	00003097          	auipc	ra,0x3
    2cd8:	2c8080e7          	jalr	712(ra) # 5f9c <printf>
    exit(1);
    2cdc:	4505                	li	a0,1
    ...
    2cec:	46050513          	add	a0,a0,1120 # 7148 <malloc+0x10f4>
    2cf0:	00003097          	auipc	ra,0x3
    2cf4:	2ac080e7          	jalr	684(ra) # 5f9c <printf>
    exit(1);
    2cf8:	4505                	li	a0,1
    ...
    2d08:	e2450513          	add	a0,a0,-476 # 6b28 <malloc+0xad4>
    2d0c:	00003097          	auipc	ra,0x3
    2d10:	290080e7          	jalr	656(ra) # 5f9c <printf>
    exit(1);
    2d14:	4505                	li	a0,1
...
0000000000002d1e <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d32:	43250513          	add	a0,a0,1074 # 7160 <malloc+0x110c>
  ...
  close(fd);
    ...
    2d7a:	cc250513          	add	a0,a0,-830 # 6a38 <malloc+0x9e4>
    2d7e:	00003097          	auipc	ra,0x3
    2d82:	21e080e7          	jalr	542(ra) # 5f9c <printf>
    exit(1);
    2d86:	4505                	li	a0,1
...
0000000000002d90 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc8:	06450513          	add	a0,a0,100 # 6e28 <malloc+0xdd4>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	1d0080e7          	jalr	464(ra) # 5f9c <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e1e:	00e50513          	add	a0,a0,14 # 6e28 <malloc+0xdd4>
    2e22:	00003097          	auipc	ra,0x3
    2e26:	17a080e7          	jalr	378(ra) # 5f9c <printf>
    exit(1);
    2e2a:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e7e:	fae50513          	add	a0,a0,-82 # 6e28 <malloc+0xdd4>
    2e82:	00003097          	auipc	ra,0x3
    2e86:	11a080e7          	jalr	282(ra) # 5f9c <printf>
    exit(1);
    2e8a:	4505                	li	a0,1
...
0000000000002fb0 <execout>:
{
  ...
  exit(0);
    ...
    2ff2:	e3a50513          	add	a0,a0,-454 # 6e28 <malloc+0xdd4>
    2ff6:	00003097          	auipc	ra,0x3
    2ffa:	fa6080e7          	jalr	-90(ra) # 5f9c <printf>
      exit(1);
    2ffe:	4505                	li	a0,1
    ...
    3046:	15650513          	add	a0,a0,342 # 6198 <malloc+0x144>
    304a:	faa43c23          	sd	a0,-72(s0)
    304e:	00003797          	auipc	a5,0x3
    3052:	1ba78793          	add	a5,a5,442 # 6208 <malloc+0x1b4>
...
0000000000003074 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3084:	2b850513          	add	a0,a0,696 # 7338 <malloc+0x12e4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3096:	0fe50513          	add	a0,a0,254 # 7190 <malloc+0x113c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30ac:	14050513          	add	a0,a0,320 # 71e8 <malloc+0x1194>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30ca:	19a50513          	add	a0,a0,410 # 7260 <malloc+0x120c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e6:	1ee50513          	add	a0,a0,494 # 72d0 <malloc+0x127c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f8:	23450513          	add	a0,a0,564 # 7328 <malloc+0x12d4>
  ...
  unlink("12345678901234");
    ...
    3176:	ff650513          	add	a0,a0,-10 # 7168 <malloc+0x1114>
    317a:	00003097          	auipc	ra,0x3
    317e:	e22080e7          	jalr	-478(ra) # 5f9c <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    3192:	02250513          	add	a0,a0,34 # 71b0 <malloc+0x115c>
    3196:	00003097          	auipc	ra,0x3
    319a:	e06080e7          	jalr	-506(ra) # 5f9c <printf>
    exit(1);
    319e:	4505                	li	a0,1
    ...
    31ae:	06e50513          	add	a0,a0,110 # 7218 <malloc+0x11c4>
    31b2:	00003097          	auipc	ra,0x3
    31b6:	dea080e7          	jalr	-534(ra) # 5f9c <printf>
    exit(1);
    31ba:	4505                	li	a0,1
    ...
    31ca:	0ca50513          	add	a0,a0,202 # 7290 <malloc+0x123c>
    31ce:	00003097          	auipc	ra,0x3
    31d2:	dce080e7          	jalr	-562(ra) # 5f9c <printf>
    exit(1);
    31d6:	4505                	li	a0,1
    ...
    31e6:	10e50513          	add	a0,a0,270 # 72f0 <malloc+0x129c>
    31ea:	00003097          	auipc	ra,0x3
    31ee:	db2080e7          	jalr	-590(ra) # 5f9c <printf>
    exit(1);
    31f2:	4505                	li	a0,1
    ...
    3202:	14a50513          	add	a0,a0,330 # 7348 <malloc+0x12f4>
    3206:	00003097          	auipc	ra,0x3
    320a:	d96080e7          	jalr	-618(ra) # 5f9c <printf>
    exit(1);
    320e:	4505                	li	a0,1
...
0000000000003218 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3252:	13250513          	add	a0,a0,306 # 7380 <malloc+0x132c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    3282:	11250513          	add	a0,a0,274 # 7390 <malloc+0x133c>
    3286:	00003097          	auipc	ra,0x3
    328a:	d16080e7          	jalr	-746(ra) # 5f9c <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3310:	07450513          	add	a0,a0,116 # 7380 <malloc+0x132c>
  ...
  unlink("diskfulldir");
    ...
    3324:	06050513          	add	a0,a0,96 # 7380 <malloc+0x132c>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    345c:	f5850513          	add	a0,a0,-168 # 73b0 <malloc+0x135c>
    3460:	00003097          	auipc	ra,0x3
    3464:	b3c080e7          	jalr	-1220(ra) # 5f9c <printf>
...
000000000000346a <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
    ...
    348e:	f5650513          	add	a0,a0,-170 # 73e0 <malloc+0x138c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    34a2:	f8250513          	add	a0,a0,-126 # 7420 <malloc+0x13cc>
  ...
  if(chdir("/") < 0){
    ...
    34b6:	f9e50513          	add	a0,a0,-98 # 7450 <malloc+0x13fc>
    ...
    34d6:	f1650513          	add	a0,a0,-234 # 73e8 <malloc+0x1394>
    34da:	00003097          	auipc	ra,0x3
    34de:	ac2080e7          	jalr	-1342(ra) # 5f9c <printf>
    exit(1);
    34e2:	4505                	li	a0,1
    ...
    34f2:	f1250513          	add	a0,a0,-238 # 7400 <malloc+0x13ac>
    34f6:	00003097          	auipc	ra,0x3
    34fa:	aa6080e7          	jalr	-1370(ra) # 5f9c <printf>
    exit(1);
    34fe:	4505                	li	a0,1
    ...
    350e:	f2650513          	add	a0,a0,-218 # 7430 <malloc+0x13dc>
    3512:	00003097          	auipc	ra,0x3
    3516:	a8a080e7          	jalr	-1398(ra) # 5f9c <printf>
    exit(1);
    351a:	4505                	li	a0,1
    ...
    352a:	f3250513          	add	a0,a0,-206 # 7458 <malloc+0x1404>
    352e:	00003097          	auipc	ra,0x3
    3532:	a6e080e7          	jalr	-1426(ra) # 5f9c <printf>
    exit(1);
    3536:	4505                	li	a0,1
...
0000000000003540 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3572:	e7250513          	add	a0,a0,-398 # 73e0 <malloc+0x138c>
    ...
    3586:	e9e50513          	add	a0,a0,-354 # 7420 <malloc+0x13cc>
    ...
    35a6:	47e50513          	add	a0,a0,1150 # 6a20 <malloc+0x9cc>
    35aa:	00003097          	auipc	ra,0x3
    35ae:	9f2080e7          	jalr	-1550(ra) # 5f9c <printf>
    exit(1);
    35b2:	4505                	li	a0,1
    ...
    35c2:	e2a50513          	add	a0,a0,-470 # 73e8 <malloc+0x1394>
    35c6:	00003097          	auipc	ra,0x3
    35ca:	9d6080e7          	jalr	-1578(ra) # 5f9c <printf>
      exit(1);
    35ce:	4505                	li	a0,1
    ...
    35de:	e9650513          	add	a0,a0,-362 # 7470 <malloc+0x141c>
    35e2:	00003097          	auipc	ra,0x3
    35e6:	9ba080e7          	jalr	-1606(ra) # 5f9c <printf>
      exit(1);
    35ea:	4505                	li	a0,1
    ...
    35fa:	e3a50513          	add	a0,a0,-454 # 7430 <malloc+0x13dc>
    35fe:	00003097          	auipc	ra,0x3
    3602:	99e080e7          	jalr	-1634(ra) # 5f9c <printf>
      exit(1);
    3606:	4505                	li	a0,1
...
0000000000003628 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
    ...
    364c:	e4050513          	add	a0,a0,-448 # 7488 <malloc+0x1434>
  ...
  if(chdir("..") < 0){
    ...
    3660:	e4c50513          	add	a0,a0,-436 # 74a8 <malloc+0x1454>
  ...
  if(unlink("dir0") < 0){
    ...
    3674:	e1850513          	add	a0,a0,-488 # 7488 <malloc+0x1434>
    ...
    3694:	d5850513          	add	a0,a0,-680 # 73e8 <malloc+0x1394>
    3698:	00003097          	auipc	ra,0x3
    369c:	904080e7          	jalr	-1788(ra) # 5f9c <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	de450513          	add	a0,a0,-540 # 7490 <malloc+0x143c>
    36b4:	00003097          	auipc	ra,0x3
    36b8:	8e8080e7          	jalr	-1816(ra) # 5f9c <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	de850513          	add	a0,a0,-536 # 74b0 <malloc+0x145c>
    36d0:	00003097          	auipc	ra,0x3
    36d4:	8cc080e7          	jalr	-1844(ra) # 5f9c <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	de450513          	add	a0,a0,-540 # 74c8 <malloc+0x1474>
    36ec:	00003097          	auipc	ra,0x3
    36f0:	8b0080e7          	jalr	-1872(ra) # 5f9c <printf>
    exit(1);
    36f4:	4505                	li	a0,1
...
00000000000036fe <subdir>:
{
  ...
  unlink("ff");
    ...
    3710:	f0450513          	add	a0,a0,-252 # 7610 <malloc+0x15bc>
    3714:	00002097          	auipc	ra,0x2
    3718:	568080e7          	jalr	1384(ra) # 5c7c <unlink>
  if(mkdir("dd") != 0){
    371c:	00004517          	auipc	a0,0x4
    3720:	dc450513          	add	a0,a0,-572 # 74e0 <malloc+0x148c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3738:	dcc50513          	add	a0,a0,-564 # 7500 <malloc+0x14ac>
  ...
  write(fd, "ff", 2);
    ...
    3750:	ec458593          	add	a1,a1,-316 # 7610 <malloc+0x15bc>
  ...
  if(unlink("dd") >= 0){
    ...
    376a:	d7a50513          	add	a0,a0,-646 # 74e0 <malloc+0x148c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    377e:	dde50513          	add	a0,a0,-546 # 7558 <malloc+0x1504>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3796:	dee50513          	add	a0,a0,-530 # 7580 <malloc+0x152c>
  ...
  write(fd, "FF", 2);
    ...
    37ae:	e0658593          	add	a1,a1,-506 # 75b0 <malloc+0x155c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37ca:	df250513          	add	a0,a0,-526 # 75b8 <malloc+0x1564>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3812:	dfa58593          	add	a1,a1,-518 # 7608 <malloc+0x15b4>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    382e:	d5650513          	add	a0,a0,-682 # 7580 <malloc+0x152c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3844:	d4050513          	add	a0,a0,-704 # 7580 <malloc+0x152c>
  ...
  if(chdir("dd") != 0){
    ...
    3858:	c8c50513          	add	a0,a0,-884 # 74e0 <malloc+0x148c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    386c:	e3850513          	add	a0,a0,-456 # 76a0 <malloc+0x164c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3880:	e5450513          	add	a0,a0,-428 # 76d0 <malloc+0x167c>
  ...
  if(chdir("./..") != 0){
    ...
    3894:	e7050513          	add	a0,a0,-400 # 7700 <malloc+0x16ac>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    38aa:	d6250513          	add	a0,a0,-670 # 7608 <malloc+0x15b4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38e4:	ca050513          	add	a0,a0,-864 # 7580 <malloc+0x152c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38fc:	e9850513          	add	a0,a0,-360 # 7790 <malloc+0x173c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3914:	eb050513          	add	a0,a0,-336 # 77c0 <malloc+0x176c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    392c:	bb850513          	add	a0,a0,-1096 # 74e0 <malloc+0x148c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3942:	ba250513          	add	a0,a0,-1118 # 74e0 <malloc+0x148c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3958:	b8c50513          	add	a0,a0,-1140 # 74e0 <malloc+0x148c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    396c:	ee858593          	add	a1,a1,-280 # 7850 <malloc+0x17fc>
    3970:	00004517          	auipc	a0,0x4
    3974:	e2050513          	add	a0,a0,-480 # 7790 <malloc+0x173c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3988:	ecc58593          	add	a1,a1,-308 # 7850 <malloc+0x17fc>
    398c:	00004517          	auipc	a0,0x4
    3990:	e3450513          	add	a0,a0,-460 # 77c0 <malloc+0x176c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    39a4:	c6858593          	add	a1,a1,-920 # 7608 <malloc+0x15b4>
    39a8:	00004517          	auipc	a0,0x4
    39ac:	b5850513          	add	a0,a0,-1192 # 7500 <malloc+0x14ac>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39c0:	dd450513          	add	a0,a0,-556 # 7790 <malloc+0x173c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39d4:	df050513          	add	a0,a0,-528 # 77c0 <malloc+0x176c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39e8:	c2450513          	add	a0,a0,-988 # 7608 <malloc+0x15b4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39fc:	dc850513          	add	a0,a0,-568 # 77c0 <malloc+0x176c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3a10:	d8450513          	add	a0,a0,-636 # 7790 <malloc+0x173c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a24:	ae050513          	add	a0,a0,-1312 # 7500 <malloc+0x14ac>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a38:	f6c50513          	add	a0,a0,-148 # 79a0 <malloc+0x194c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a4c:	bc050513          	add	a0,a0,-1088 # 7608 <malloc+0x15b4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a60:	aa450513          	add	a0,a0,-1372 # 7500 <malloc+0x14ac>
  ...
  if(unlink("dd") == 0){
    ...
    3a74:	a7050513          	add	a0,a0,-1424 # 74e0 <malloc+0x148c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a88:	f8c50513          	add	a0,a0,-116 # 7a10 <malloc+0x19bc>
  ...
  if(unlink("dd") < 0){
    ...
    3a9c:	a4850513          	add	a0,a0,-1464 # 74e0 <malloc+0x148c>
    ...
    3abe:	a2e50513          	add	a0,a0,-1490 # 74e8 <malloc+0x1494>
    3ac2:	00002097          	auipc	ra,0x2
    3ac6:	4da080e7          	jalr	1242(ra) # 5f9c <printf>
    exit(1);
    3aca:	4505                	li	a0,1
    ...
    3ada:	a3250513          	add	a0,a0,-1486 # 7508 <malloc+0x14b4>
    3ade:	00002097          	auipc	ra,0x2
    3ae2:	4be080e7          	jalr	1214(ra) # 5f9c <printf>
    exit(1);
    3ae6:	4505                	li	a0,1
    ...
    3af6:	a3650513          	add	a0,a0,-1482 # 7528 <malloc+0x14d4>
    3afa:	00002097          	auipc	ra,0x2
    3afe:	4a2080e7          	jalr	1186(ra) # 5f9c <printf>
    exit(1);
    3b02:	4505                	li	a0,1
    ...
    3b12:	a5250513          	add	a0,a0,-1454 # 7560 <malloc+0x150c>
    3b16:	00002097          	auipc	ra,0x2
    3b1a:	486080e7          	jalr	1158(ra) # 5f9c <printf>
    exit(1);
    3b1e:	4505                	li	a0,1
    ...
    3b2e:	a6650513          	add	a0,a0,-1434 # 7590 <malloc+0x153c>
    3b32:	00002097          	auipc	ra,0x2
    3b36:	46a080e7          	jalr	1130(ra) # 5f9c <printf>
    exit(1);
    3b3a:	4505                	li	a0,1
    ...
    3b4a:	a8250513          	add	a0,a0,-1406 # 75c8 <malloc+0x1574>
    3b4e:	00002097          	auipc	ra,0x2
    3b52:	44e080e7          	jalr	1102(ra) # 5f9c <printf>
    exit(1);
    3b56:	4505                	li	a0,1
    ...
    3b66:	a8650513          	add	a0,a0,-1402 # 75e8 <malloc+0x1594>
    3b6a:	00002097          	auipc	ra,0x2
    3b6e:	432080e7          	jalr	1074(ra) # 5f9c <printf>
    exit(1);
    3b72:	4505                	li	a0,1
    ...
    3b82:	a9a50513          	add	a0,a0,-1382 # 7618 <malloc+0x15c4>
    3b86:	00002097          	auipc	ra,0x2
    3b8a:	416080e7          	jalr	1046(ra) # 5f9c <printf>
    exit(1);
    3b8e:	4505                	li	a0,1
    ...
    3b9e:	aa650513          	add	a0,a0,-1370 # 7640 <malloc+0x15ec>
    3ba2:	00002097          	auipc	ra,0x2
    3ba6:	3fa080e7          	jalr	1018(ra) # 5f9c <printf>
    exit(1);
    3baa:	4505                	li	a0,1
    ...
    3bba:	aaa50513          	add	a0,a0,-1366 # 7660 <malloc+0x160c>
    3bbe:	00002097          	auipc	ra,0x2
    3bc2:	3de080e7          	jalr	990(ra) # 5f9c <printf>
    exit(1);
    3bc6:	4505                	li	a0,1
    ...
    3bd6:	ab650513          	add	a0,a0,-1354 # 7688 <malloc+0x1634>
    3bda:	00002097          	auipc	ra,0x2
    3bde:	3c2080e7          	jalr	962(ra) # 5f9c <printf>
    exit(1);
    3be2:	4505                	li	a0,1
    ...
    3bf2:	ac250513          	add	a0,a0,-1342 # 76b0 <malloc+0x165c>
    3bf6:	00002097          	auipc	ra,0x2
    3bfa:	3a6080e7          	jalr	934(ra) # 5f9c <printf>
    exit(1);
    3bfe:	4505                	li	a0,1
    ...
    3c0e:	ad650513          	add	a0,a0,-1322 # 76e0 <malloc+0x168c>
    3c12:	00002097          	auipc	ra,0x2
    3c16:	38a080e7          	jalr	906(ra) # 5f9c <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	ae250513          	add	a0,a0,-1310 # 7708 <malloc+0x16b4>
    3c2e:	00002097          	auipc	ra,0x2
    3c32:	36e080e7          	jalr	878(ra) # 5f9c <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c46:	ade50513          	add	a0,a0,-1314 # 7720 <malloc+0x16cc>
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	352080e7          	jalr	850(ra) # 5f9c <printf>
    exit(1);
    3c52:	4505                	li	a0,1
    ...
    3c62:	ae250513          	add	a0,a0,-1310 # 7740 <malloc+0x16ec>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	336080e7          	jalr	822(ra) # 5f9c <printf>
    exit(1);
    3c6e:	4505                	li	a0,1
    ...
    3c7e:	ae650513          	add	a0,a0,-1306 # 7760 <malloc+0x170c>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	31a080e7          	jalr	794(ra) # 5f9c <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	b0a50513          	add	a0,a0,-1270 # 77a0 <malloc+0x174c>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	2fe080e7          	jalr	766(ra) # 5f9c <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	b1e50513          	add	a0,a0,-1250 # 77d0 <malloc+0x177c>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	2e2080e7          	jalr	738(ra) # 5f9c <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	b2250513          	add	a0,a0,-1246 # 77f0 <malloc+0x179c>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	2c6080e7          	jalr	710(ra) # 5f9c <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	b2650513          	add	a0,a0,-1242 # 7810 <malloc+0x17bc>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	2aa080e7          	jalr	682(ra) # 5f9c <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	b2a50513          	add	a0,a0,-1238 # 7830 <malloc+0x17dc>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	28e080e7          	jalr	654(ra) # 5f9c <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	b3e50513          	add	a0,a0,-1218 # 7860 <malloc+0x180c>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	272080e7          	jalr	626(ra) # 5f9c <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	b4a50513          	add	a0,a0,-1206 # 7888 <malloc+0x1834>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	256080e7          	jalr	598(ra) # 5f9c <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	b5650513          	add	a0,a0,-1194 # 78b0 <malloc+0x185c>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	23a080e7          	jalr	570(ra) # 5f9c <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	b6250513          	add	a0,a0,-1182 # 78d8 <malloc+0x1884>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	21e080e7          	jalr	542(ra) # 5f9c <printf>
    exit(1);
    3d86:	4505                	li	a0,1
    ...
    3d96:	b6650513          	add	a0,a0,-1178 # 78f8 <malloc+0x18a4>
    3d9a:	00002097          	auipc	ra,0x2
    3d9e:	202080e7          	jalr	514(ra) # 5f9c <printf>
    exit(1);
    3da2:	4505                	li	a0,1
    ...
    3db2:	b6a50513          	add	a0,a0,-1174 # 7918 <malloc+0x18c4>
    3db6:	00002097          	auipc	ra,0x2
    3dba:	1e6080e7          	jalr	486(ra) # 5f9c <printf>
    exit(1);
    3dbe:	4505                	li	a0,1
    ...
    3dce:	b7650513          	add	a0,a0,-1162 # 7940 <malloc+0x18ec>
    3dd2:	00002097          	auipc	ra,0x2
    3dd6:	1ca080e7          	jalr	458(ra) # 5f9c <printf>
    exit(1);
    3dda:	4505                	li	a0,1
    ...
    3dea:	b7a50513          	add	a0,a0,-1158 # 7960 <malloc+0x190c>
    3dee:	00002097          	auipc	ra,0x2
    3df2:	1ae080e7          	jalr	430(ra) # 5f9c <printf>
    exit(1);
    3df6:	4505                	li	a0,1
    ...
    3e06:	b7e50513          	add	a0,a0,-1154 # 7980 <malloc+0x192c>
    3e0a:	00002097          	auipc	ra,0x2
    3e0e:	192080e7          	jalr	402(ra) # 5f9c <printf>
    exit(1);
    3e12:	4505                	li	a0,1
    ...
    3e22:	b8a50513          	add	a0,a0,-1142 # 79a8 <malloc+0x1954>
    3e26:	00002097          	auipc	ra,0x2
    3e2a:	176080e7          	jalr	374(ra) # 5f9c <printf>
    exit(1);
    3e2e:	4505                	li	a0,1
    ...
    3e3e:	80650513          	add	a0,a0,-2042 # 7640 <malloc+0x15ec>
    3e42:	00002097          	auipc	ra,0x2
    3e46:	15a080e7          	jalr	346(ra) # 5f9c <printf>
    exit(1);
    3e4a:	4505                	li	a0,1
    ...
    3e5a:	b7250513          	add	a0,a0,-1166 # 79c8 <malloc+0x1974>
    3e5e:	00002097          	auipc	ra,0x2
    3e62:	13e080e7          	jalr	318(ra) # 5f9c <printf>
    exit(1);
    3e66:	4505                	li	a0,1
    ...
    3e76:	b7650513          	add	a0,a0,-1162 # 79e8 <malloc+0x1994>
    3e7a:	00002097          	auipc	ra,0x2
    3e7e:	122080e7          	jalr	290(ra) # 5f9c <printf>
    exit(1);
    3e82:	4505                	li	a0,1
    ...
    3e92:	b8a50513          	add	a0,a0,-1142 # 7a18 <malloc+0x19c4>
    3e96:	00002097          	auipc	ra,0x2
    3e9a:	106080e7          	jalr	262(ra) # 5f9c <printf>
    exit(1);
    3e9e:	4505                	li	a0,1
    ...
    3eae:	b8e50513          	add	a0,a0,-1138 # 7a38 <malloc+0x19e4>
    3eb2:	00002097          	auipc	ra,0x2
    3eb6:	0ea080e7          	jalr	234(ra) # 5f9c <printf>
    exit(1);
    3eba:	4505                	li	a0,1
...
0000000000003ec4 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ed4:	b8050513          	add	a0,a0,-1152 # 7a50 <malloc+0x19fc>
  ...
  if(chdir("dots") != 0){
    ...
    3ee6:	b6e50513          	add	a0,a0,-1170 # 7a50 <malloc+0x19fc>
  ...
  if(unlink(".") == 0){
    ...
    3ef8:	98c50513          	add	a0,a0,-1652 # 6880 <malloc+0x82c>
  ...
  if(unlink("..") == 0){
    ...
    3f0a:	5a250513          	add	a0,a0,1442 # 74a8 <malloc+0x1454>
  ...
  if(chdir("/") != 0){
    ...
    3f1c:	53850513          	add	a0,a0,1336 # 7450 <malloc+0x13fc>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f2e:	b8e50513          	add	a0,a0,-1138 # 7ab8 <malloc+0x1a64>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f40:	ba450513          	add	a0,a0,-1116 # 7ae0 <malloc+0x1a8c>
  ...
  if(unlink("dots") != 0){
    ...
    3f52:	b0250513          	add	a0,a0,-1278 # 7a50 <malloc+0x19fc>
    ...
    3f70:	aec50513          	add	a0,a0,-1300 # 7a58 <malloc+0x1a04>
    3f74:	00002097          	auipc	ra,0x2
    3f78:	028080e7          	jalr	40(ra) # 5f9c <printf>
    exit(1);
    3f7c:	4505                	li	a0,1
    ...
    3f8c:	ae850513          	add	a0,a0,-1304 # 7a70 <malloc+0x1a1c>
    3f90:	00002097          	auipc	ra,0x2
    3f94:	00c080e7          	jalr	12(ra) # 5f9c <printf>
    exit(1);
    3f98:	4505                	li	a0,1
    ...
    3fa8:	ae450513          	add	a0,a0,-1308 # 7a88 <malloc+0x1a34>
    3fac:	00002097          	auipc	ra,0x2
    3fb0:	ff0080e7          	jalr	-16(ra) # 5f9c <printf>
    exit(1);
    3fb4:	4505                	li	a0,1
    ...
    3fc4:	ae050513          	add	a0,a0,-1312 # 7aa0 <malloc+0x1a4c>
    3fc8:	00002097          	auipc	ra,0x2
    3fcc:	fd4080e7          	jalr	-44(ra) # 5f9c <printf>
    exit(1);
    3fd0:	4505                	li	a0,1
    ...
    3fe0:	47c50513          	add	a0,a0,1148 # 7458 <malloc+0x1404>
    3fe4:	00002097          	auipc	ra,0x2
    3fe8:	fb8080e7          	jalr	-72(ra) # 5f9c <printf>
    exit(1);
    3fec:	4505                	li	a0,1
    ...
    3ffc:	ac850513          	add	a0,a0,-1336 # 7ac0 <malloc+0x1a6c>
    4000:	00002097          	auipc	ra,0x2
    4004:	f9c080e7          	jalr	-100(ra) # 5f9c <printf>
    exit(1);
    4008:	4505                	li	a0,1
    ...
    4018:	ad450513          	add	a0,a0,-1324 # 7ae8 <malloc+0x1a94>
    401c:	00002097          	auipc	ra,0x2
    4020:	f80080e7          	jalr	-128(ra) # 5f9c <printf>
    exit(1);
    4024:	4505                	li	a0,1
    ...
    4034:	ad850513          	add	a0,a0,-1320 # 7b08 <malloc+0x1ab4>
    4038:	00002097          	auipc	ra,0x2
    403c:	f64080e7          	jalr	-156(ra) # 5f9c <printf>
    exit(1);
    4040:	4505                	li	a0,1
...
000000000000404a <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4060:	acc50513          	add	a0,a0,-1332 # 7b28 <malloc+0x1ad4>
  ...
  if(chdir("dirfile") == 0){
    ...
    407c:	ab050513          	add	a0,a0,-1360 # 7b28 <malloc+0x1ad4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4090:	ae450513          	add	a0,a0,-1308 # 7b70 <malloc+0x1b1c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40d0:	aa450513          	add	a0,a0,-1372 # 7b70 <malloc+0x1b1c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40e4:	a9058593          	add	a1,a1,-1392 # 7b70 <malloc+0x1b1c>
    40e8:	00002517          	auipc	a0,0x2
    40ec:	28850513          	add	a0,a0,648 # 6370 <malloc+0x31c>
  ...
  if(unlink("dirfile") != 0){
    ...
    4100:	a2c50513          	add	a0,a0,-1492 # 7b28 <malloc+0x1ad4>
  ...
  fd = open(".", O_RDWR);
    ...
    4116:	76e50513          	add	a0,a0,1902 # 6880 <malloc+0x82c>
  ...
  fd = open(".", 0);
    ...
    412c:	75850513          	add	a0,a0,1880 # 6880 <malloc+0x82c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    4140:	0cc58593          	add	a1,a1,204 # 6208 <malloc+0x1b4>
  ...
  close(fd);
    ...
    416c:	9c850513          	add	a0,a0,-1592 # 7b30 <malloc+0x1adc>
    4170:	00002097          	auipc	ra,0x2
    4174:	e2c080e7          	jalr	-468(ra) # 5f9c <printf>
    exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	9cc50513          	add	a0,a0,-1588 # 7b50 <malloc+0x1afc>
    418c:	00002097          	auipc	ra,0x2
    4190:	e10080e7          	jalr	-496(ra) # 5f9c <printf>
    exit(1);
    4194:	4505                	li	a0,1
    ...
    41a4:	9e050513          	add	a0,a0,-1568 # 7b80 <malloc+0x1b2c>
    41a8:	00002097          	auipc	ra,0x2
    41ac:	df4080e7          	jalr	-524(ra) # 5f9c <printf>
    exit(1);
    41b0:	4505                	li	a0,1
    ...
    41c0:	9c450513          	add	a0,a0,-1596 # 7b80 <malloc+0x1b2c>
    41c4:	00002097          	auipc	ra,0x2
    41c8:	dd8080e7          	jalr	-552(ra) # 5f9c <printf>
    exit(1);
    41cc:	4505                	li	a0,1
    ...
    41dc:	9d050513          	add	a0,a0,-1584 # 7ba8 <malloc+0x1b54>
    41e0:	00002097          	auipc	ra,0x2
    41e4:	dbc080e7          	jalr	-580(ra) # 5f9c <printf>
    exit(1);
    41e8:	4505                	li	a0,1
    ...
    41f8:	9dc50513          	add	a0,a0,-1572 # 7bd0 <malloc+0x1b7c>
    41fc:	00002097          	auipc	ra,0x2
    4200:	da0080e7          	jalr	-608(ra) # 5f9c <printf>
    exit(1);
    4204:	4505                	li	a0,1
    ...
    4214:	9e850513          	add	a0,a0,-1560 # 7bf8 <malloc+0x1ba4>
    4218:	00002097          	auipc	ra,0x2
    421c:	d84080e7          	jalr	-636(ra) # 5f9c <printf>
    exit(1);
    4220:	4505                	li	a0,1
    ...
    4230:	9f450513          	add	a0,a0,-1548 # 7c20 <malloc+0x1bcc>
    4234:	00002097          	auipc	ra,0x2
    4238:	d68080e7          	jalr	-664(ra) # 5f9c <printf>
    exit(1);
    423c:	4505                	li	a0,1
    ...
    424c:	9f850513          	add	a0,a0,-1544 # 7c40 <malloc+0x1bec>
    4250:	00002097          	auipc	ra,0x2
    4254:	d4c080e7          	jalr	-692(ra) # 5f9c <printf>
    exit(1);
    4258:	4505                	li	a0,1
    ...
    4268:	a0450513          	add	a0,a0,-1532 # 7c68 <malloc+0x1c14>
    426c:	00002097          	auipc	ra,0x2
    4270:	d30080e7          	jalr	-720(ra) # 5f9c <printf>
    exit(1);
    4274:	4505                	li	a0,1
...
000000000000427e <iref>:
{
    ...
    429c:	9e8a0a13          	add	s4,s4,-1560 # 7c80 <malloc+0x1c2c>
    mkdir("");
    42a0:	00003497          	auipc	s1,0x3
    42a4:	4e848493          	add	s1,s1,1256 # 7788 <malloc+0x1734>
    link("README", "");
    42a8:	00002a97          	auipc	s5,0x2
    42ac:	0c8a8a93          	add	s5,s5,200 # 6370 <malloc+0x31c>
    fd = open("xx", O_CREATE);
    42b0:	00004997          	auipc	s3,0x4
    42b4:	8c898993          	add	s3,s3,-1848 # 7b78 <malloc+0x1b24>
    42b8:	a891                	j	430c <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42ba:	85da                	mv	a1,s6
    42bc:	00004517          	auipc	a0,0x4
    42c0:	9cc50513          	add	a0,a0,-1588 # 7c88 <malloc+0x1c34>
    42c4:	00002097          	auipc	ra,0x2
    42c8:	cd8080e7          	jalr	-808(ra) # 5f9c <printf>
      exit(1);
    42cc:	4505                	li	a0,1
    ...
    42dc:	9c850513          	add	a0,a0,-1592 # 7ca0 <malloc+0x1c4c>
    42e0:	00002097          	auipc	ra,0x2
    42e4:	cbc080e7          	jalr	-836(ra) # 5f9c <printf>
      exit(1);
    42e8:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4370:	13c98993          	add	s3,s3,316 # 74a8 <malloc+0x1454>
    unlink("irefd");
    4374:	00004917          	auipc	s2,0x4
    4378:	90c90913          	add	s2,s2,-1780 # 7c80 <malloc+0x1c2c>
    chdir("..");
    437c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4398:	0bc50513          	add	a0,a0,188 # 7450 <malloc+0x13fc>
...
00000000000043b8 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43c8:	8f450513          	add	a0,a0,-1804 # 7cb8 <malloc+0x1c64>
  ...
  if(pid == 0){
    ...
    43ec:	8d050513          	add	a0,a0,-1840 # 7cb8 <malloc+0x1c64>
    ...
    4402:	8da50513          	add	a0,a0,-1830 # 7cd8 <malloc+0x1c84>
    4406:	00002097          	auipc	ra,0x2
    440a:	b96080e7          	jalr	-1130(ra) # 5f9c <printf>
      exit(1);
    440e:	4505                	li	a0,1
    ...
    441e:	8a650513          	add	a0,a0,-1882 # 7cc0 <malloc+0x1c6c>
    4422:	00002097          	auipc	ra,0x2
    4426:	b7a080e7          	jalr	-1158(ra) # 5f9c <printf>
    exit(1);
    442a:	4505                	li	a0,1
    ...
    443a:	5ea50513          	add	a0,a0,1514 # 6a20 <malloc+0x9cc>
    443e:	00002097          	auipc	ra,0x2
    4442:	b5e080e7          	jalr	-1186(ra) # 5f9c <printf>
    exit(1);
    4446:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4468:	85450513          	add	a0,a0,-1964 # 7cb8 <malloc+0x1c64>
    ...
    447c:	79850513          	add	a0,a0,1944 # 6c10 <malloc+0xbbc>
    4480:	00002097          	auipc	ra,0x2
    4484:	b1c080e7          	jalr	-1252(ra) # 5f9c <printf>
    exit(1);
    4488:	4505                	li	a0,1
...
00000000000044aa <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44ba:	84a50513          	add	a0,a0,-1974 # 7d00 <malloc+0x1cac>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44e6:	81e50513          	add	a0,a0,-2018 # 7d00 <malloc+0x1cac>
  ...
  sleep(10); // one second
    ...
    451e:	6c650513          	add	a0,a0,1734 # 6be0 <malloc+0xb8c>
    4522:	00002097          	auipc	ra,0x2
    4526:	a7a080e7          	jalr	-1414(ra) # 5f9c <printf>
    exit(1);
    452a:	4505                	li	a0,1
    ...
    4538:	7cc48493          	add	s1,s1,1996 # 7d00 <malloc+0x1cac>
    453c:	4581                	li	a1,0
    453e:	8526                	mv	a0,s1
    ...
    4560:	7a450513          	add	a0,a0,1956 # 7d00 <malloc+0x1cac>
...
0000000000004580 <killstatus>:
{
  ...
  exit(0);
    ...
    45e6:	43e50513          	add	a0,a0,1086 # 6a20 <malloc+0x9cc>
    45ea:	00002097          	auipc	ra,0x2
    45ee:	9b2080e7          	jalr	-1614(ra) # 5f9c <printf>
      exit(1);
    45f2:	4505                	li	a0,1
    ...
    460c:	70850513          	add	a0,a0,1800 # 7d10 <malloc+0x1cbc>
    4610:	00002097          	auipc	ra,0x2
    4614:	98c080e7          	jalr	-1652(ra) # 5f9c <printf>
       exit(1);
    4618:	4505                	li	a0,1
...
0000000000004622 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    464c:	59850513          	add	a0,a0,1432 # 6be0 <malloc+0xb8c>
    4650:	00002097          	auipc	ra,0x2
    4654:	94c080e7          	jalr	-1716(ra) # 5f9c <printf>
    exit(1);
    4658:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    467a:	3aa50513          	add	a0,a0,938 # 6a20 <malloc+0x9cc>
    467e:	00002097          	auipc	ra,0x2
    4682:	91e080e7          	jalr	-1762(ra) # 5f9c <printf>
    exit(1);
    4686:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    46be:	b4e58593          	add	a1,a1,-1202 # 6208 <malloc+0x1b4>
    ...
    46e8:	33c50513          	add	a0,a0,828 # 6a20 <malloc+0x9cc>
    46ec:	00002097          	auipc	ra,0x2
    46f0:	8b0080e7          	jalr	-1872(ra) # 5f9c <printf>
     exit(1);
    46f4:	4505                	li	a0,1
    ...
    4704:	63050513          	add	a0,a0,1584 # 7d30 <malloc+0x1cdc>
    4708:	00002097          	auipc	ra,0x2
    470c:	894080e7          	jalr	-1900(ra) # 5f9c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4740:	60c50513          	add	a0,a0,1548 # 7d48 <malloc+0x1cf4>
    4744:	00002097          	auipc	ra,0x2
    4748:	858080e7          	jalr	-1960(ra) # 5f9c <printf>
}
  ...
  printf("kill... ");
    ...
    476c:	5f850513          	add	a0,a0,1528 # 7d60 <malloc+0x1d0c>
    4770:	00002097          	auipc	ra,0x2
    4774:	82c080e7          	jalr	-2004(ra) # 5f9c <printf>
  kill(pid1);
    4778:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    479a:	5da50513          	add	a0,a0,1498 # 7d70 <malloc+0x1d1c>
    479e:	00001097          	auipc	ra,0x1
    47a2:	7fe080e7          	jalr	2046(ra) # 5f9c <printf>
  wait(0);
    47a6:	4501                	li	a0,0
...
00000000000047c6 <reparent>:
{
  ...
  exit(0);
    ...
    481a:	20a50513          	add	a0,a0,522 # 6a20 <malloc+0x9cc>
    481e:	00001097          	auipc	ra,0x1
    4822:	77e080e7          	jalr	1918(ra) # 5f9c <printf>
      exit(1);
    4826:	4505                	li	a0,1
    ...
    4836:	37650513          	add	a0,a0,886 # 6ba8 <malloc+0xb54>
    483a:	00001097          	auipc	ra,0x1
    483e:	762080e7          	jalr	1890(ra) # 5f9c <printf>
        exit(1);
    4842:	4505                	li	a0,1
...
0000000000004876 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    48ac:	28050513          	add	a0,a0,640 # 6b28 <malloc+0xad4>
    48b0:	00001097          	auipc	ra,0x1
    48b4:	6ec080e7          	jalr	1772(ra) # 5f9c <printf>
    exit(1);
    48b8:	4505                	li	a0,1
    ...
    48e0:	92c58593          	add	a1,a1,-1748 # 6208 <malloc+0x1b4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    49a4:	3e050513          	add	a0,a0,992 # 7d80 <malloc+0x1d2c>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	5f4080e7          	jalr	1524(ra) # 5f9c <printf>
    exit(1);
    49b0:	4505                	li	a0,1
    ...
    49c0:	06450513          	add	a0,a0,100 # 6a20 <malloc+0x9cc>
    49c4:	00001097          	auipc	ra,0x1
    49c8:	5d8080e7          	jalr	1496(ra) # 5f9c <printf>
    exit(1);
    49cc:	4505                	li	a0,1
    ...
    4a0c:	39850513          	add	a0,a0,920 # 7da0 <malloc+0x1d4c>
    4a10:	00001097          	auipc	ra,0x1
    4a14:	58c080e7          	jalr	1420(ra) # 5f9c <printf>
    exit(1);
    4a18:	4505                	li	a0,1
...
0000000000004a2c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a76:	5e2080e7          	jalr	1506(ra) # 6054 <malloc>
    ...
    4ab0:	32450513          	add	a0,a0,804 # 7dd0 <malloc+0x1d7c>
    4ab4:	00001097          	auipc	ra,0x1
    4ab8:	4e8080e7          	jalr	1256(ra) # 5f9c <printf>
      exit(1);
    4abc:	4505                	li	a0,1
...
0000000000004ad0 <sharedfd>:
{
  ...
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4af4:	30050513          	add	a0,a0,768 # 7df0 <malloc+0x1d9c>
  ...
  if(pid == 0) {
    ...
    4b72:	29250513          	add	a0,a0,658 # 7e00 <malloc+0x1dac>
    4b76:	00001097          	auipc	ra,0x1
    4b7a:	426080e7          	jalr	1062(ra) # 5f9c <printf>
    exit(1);
    4b7e:	4505                	li	a0,1
    ...
    4b8e:	29e50513          	add	a0,a0,670 # 7e28 <malloc+0x1dd4>
    4b92:	00001097          	auipc	ra,0x1
    4b96:	40a080e7          	jalr	1034(ra) # 5f9c <printf>
      exit(1);
    4b9a:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4bd2:	22250513          	add	a0,a0,546 # 7df0 <malloc+0x1d9c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4c12:	23a50513          	add	a0,a0,570 # 7e48 <malloc+0x1df4>
    4c16:	00001097          	auipc	ra,0x1
    4c1a:	386080e7          	jalr	902(ra) # 5f9c <printf>
    exit(1);
    4c1e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4c4e:	1a650513          	add	a0,a0,422 # 7df0 <malloc+0x1d9c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c74:	20050513          	add	a0,a0,512 # 7e70 <malloc+0x1e1c>
    4c78:	00001097          	auipc	ra,0x1
    4c7c:	324080e7          	jalr	804(ra) # 5f9c <printf>
    exit(1);
    4c80:	4505                	li	a0,1
...
0000000000004c94 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4cb8:	1d478793          	add	a5,a5,468 # 7e88 <malloc+0x1e34>
    4cbc:	f6f43823          	sd	a5,-144(s0)
    4cc0:	00003797          	auipc	a5,0x3
    4cc4:	1d078793          	add	a5,a5,464 # 7e90 <malloc+0x1e3c>
    4cc8:	f6f43c23          	sd	a5,-136(s0)
    4ccc:	00003797          	auipc	a5,0x3
    4cd0:	1cc78793          	add	a5,a5,460 # 7e98 <malloc+0x1e44>
    4cd4:	f8f43023          	sd	a5,-128(s0)
    4cd8:	00003797          	auipc	a5,0x3
    4cdc:	1c878793          	add	a5,a5,456 # 7ea0 <malloc+0x1e4c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d4a:	0e250513          	add	a0,a0,226 # 6e28 <malloc+0xdd4>
    4d4e:	00001097          	auipc	ra,0x1
    4d52:	24e080e7          	jalr	590(ra) # 5f9c <printf>
      exit(1);
    4d56:	4505                	li	a0,1
    ...
    4dc4:	0e850513          	add	a0,a0,232 # 7ea8 <malloc+0x1e54>
    4dc8:	00001097          	auipc	ra,0x1
    4dcc:	1d4080e7          	jalr	468(ra) # 5f9c <printf>
        exit(1);
    4dd0:	4505                	li	a0,1
    ...
    4dde:	0de50513          	add	a0,a0,222 # 7eb8 <malloc+0x1e64>
    4de2:	00001097          	auipc	ra,0x1
    4de6:	1ba080e7          	jalr	442(ra) # 5f9c <printf>
          exit(1);
    4dea:	4505                	li	a0,1
    ...
    4e04:	0d050513          	add	a0,a0,208 # 7ed0 <malloc+0x1e7c>
    4e08:	00001097          	auipc	ra,0x1
    4e0c:	194080e7          	jalr	404(ra) # 5f9c <printf>
          exit(1);
    4e10:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e8c:	05850513          	add	a0,a0,88 # 7ee0 <malloc+0x1e8c>
    4e90:	00001097          	auipc	ra,0x1
    4e94:	10c080e7          	jalr	268(ra) # 5f9c <printf>
      exit(1);
    4e98:	4505                	li	a0,1
...
0000000000004ec0 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eee:	00eb8b93          	add	s7,s7,14 # 7ef8 <malloc+0x1ea4>
  for(i = 0; i < N; i++){
    ...
    4f30:	fd450513          	add	a0,a0,-44 # 7f00 <malloc+0x1eac>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	068080e7          	jalr	104(ra) # 5f9c <printf>
        exit(1);
    4f3c:	4505                	li	a0,1
    ...
    4f4e:	fae50513          	add	a0,a0,-82 # 7ef8 <malloc+0x1ea4>
  ...
  fd = open(".", 0);
    ...
    4f86:	8fe50513          	add	a0,a0,-1794 # 6880 <malloc+0x82c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ffe:	f2650513          	add	a0,a0,-218 # 7f20 <malloc+0x1ecc>
    5002:	00001097          	auipc	ra,0x1
    5006:	f9a080e7          	jalr	-102(ra) # 5f9c <printf>
        exit(1);
    500a:	4505                	li	a0,1
    ...
    501e:	f2650513          	add	a0,a0,-218 # 7f40 <malloc+0x1eec>
    5022:	00001097          	auipc	ra,0x1
    5026:	f7a080e7          	jalr	-134(ra) # 5f9c <printf>
        exit(1);
    502a:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    5056:	f1650513          	add	a0,a0,-234 # 7f68 <malloc+0x1f14>
    505a:	00001097          	auipc	ra,0x1
    505e:	f42080e7          	jalr	-190(ra) # 5f9c <printf>
    exit(1);
    5062:	4505                	li	a0,1
    ...
    5072:	9b250513          	add	a0,a0,-1614 # 6a20 <malloc+0x9cc>
    5076:	00001097          	auipc	ra,0x1
    507a:	f26080e7          	jalr	-218(ra) # 5f9c <printf>
      exit(1);
    507e:	4505                	li	a0,1
...
000000000000521c <bigfile>:
{
  ...
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    5248:	d5c50513          	add	a0,a0,-676 # 7fa0 <malloc+0x1f4c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    52a4:	d0050513          	add	a0,a0,-768 # 7fa0 <malloc+0x1f4c>
  ...
  for(i = 0; ; i++){
    ...
    5308:	cac50513          	add	a0,a0,-852 # 7fb0 <malloc+0x1f5c>
    530c:	00001097          	auipc	ra,0x1
    5310:	c90080e7          	jalr	-880(ra) # 5f9c <printf>
    exit(1);
    5314:	4505                	li	a0,1
    ...
    5324:	cb050513          	add	a0,a0,-848 # 7fd0 <malloc+0x1f7c>
    5328:	00001097          	auipc	ra,0x1
    532c:	c74080e7          	jalr	-908(ra) # 5f9c <printf>
      exit(1);
    5330:	4505                	li	a0,1
    ...
    5340:	cb450513          	add	a0,a0,-844 # 7ff0 <malloc+0x1f9c>
    5344:	00001097          	auipc	ra,0x1
    5348:	c58080e7          	jalr	-936(ra) # 5f9c <printf>
    exit(1);
    534c:	4505                	li	a0,1
    ...
    535c:	cb850513          	add	a0,a0,-840 # 8010 <malloc+0x1fbc>
    5360:	00001097          	auipc	ra,0x1
    5364:	c3c080e7          	jalr	-964(ra) # 5f9c <printf>
      exit(1);
    5368:	4505                	li	a0,1
    ...
    5378:	cbc50513          	add	a0,a0,-836 # 8030 <malloc+0x1fdc>
    537c:	00001097          	auipc	ra,0x1
    5380:	c20080e7          	jalr	-992(ra) # 5f9c <printf>
      exit(1);
    5384:	4505                	li	a0,1
    ...
    5394:	cb850513          	add	a0,a0,-840 # 8048 <malloc+0x1ff4>
    5398:	00001097          	auipc	ra,0x1
    539c:	c04080e7          	jalr	-1020(ra) # 5f9c <printf>
      exit(1);
    53a0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    53c2:	be250513          	add	a0,a0,-1054 # 7fa0 <malloc+0x1f4c>
    ...
    53e6:	c8650513          	add	a0,a0,-890 # 8068 <malloc+0x2014>
    53ea:	00001097          	auipc	ra,0x1
    53ee:	bb2080e7          	jalr	-1102(ra) # 5f9c <printf>
    exit(1);
    53f2:	4505                	li	a0,1
...
00000000000053fc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    541c:	c7050513          	add	a0,a0,-912 # 8088 <malloc+0x2034>
    5420:	00001097          	auipc	ra,0x1
    5424:	b7c080e7          	jalr	-1156(ra) # 5f9c <printf>
  for(nfiles = 0; ; nfiles++){
    5428:	4481                	li	s1,0
    name[0] = 'f';
    ...
    543c:	c60c8c93          	add	s9,s9,-928 # 8098 <malloc+0x2044>
    name[0] = 'f';
    ...
    548a:	b16080e7          	jalr	-1258(ra) # 5f9c <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    54ac:	c0050513          	add	a0,a0,-1024 # 80a8 <malloc+0x2054>
    54b0:	00001097          	auipc	ra,0x1
    54b4:	aec080e7          	jalr	-1300(ra) # 5f9c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5522:	baa50513          	add	a0,a0,-1110 # 80c8 <malloc+0x2074>
    5526:	00001097          	auipc	ra,0x1
    552a:	a76080e7          	jalr	-1418(ra) # 5f9c <printf>
}
    ...
    5578:	b4450513          	add	a0,a0,-1212 # 80b8 <malloc+0x2064>
    557c:	00001097          	auipc	ra,0x1
    5580:	a20080e7          	jalr	-1504(ra) # 5f9c <printf>
    close(fd);
    5584:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    55aa:	b3a50513          	add	a0,a0,-1222 # 80e0 <malloc+0x208c>
    55ae:	00001097          	auipc	ra,0x1
    55b2:	9ee080e7          	jalr	-1554(ra) # 5f9c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55da:	b3250513          	add	a0,a0,-1230 # 8108 <malloc+0x20b4>
    55de:	00001097          	auipc	ra,0x1
    55e2:	9be080e7          	jalr	-1602(ra) # 5f9c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55fe:	af650513          	add	a0,a0,-1290 # 80f0 <malloc+0x209c>
    5602:	00001097          	auipc	ra,0x1
    5606:	99a080e7          	jalr	-1638(ra) # 5f9c <printf>
    exit(1);
    560a:	4505                	li	a0,1
    ...
    5626:	aee50513          	add	a0,a0,-1298 # 8110 <malloc+0x20bc>
    562a:	00001097          	auipc	ra,0x1
    562e:	972080e7          	jalr	-1678(ra) # 5f9c <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    567e:	a9e50513          	add	a0,a0,-1378 # 8118 <malloc+0x20c4>
    5682:	00001097          	auipc	ra,0x1
    5686:	91a080e7          	jalr	-1766(ra) # 5f9c <printf>
          return 1;
    568a:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56e8:	b2498993          	add	s3,s3,-1244 # 6208 <malloc+0x1b4>
      uint64 a = (uint64) sbrk(4096);
    ...
    571a:	a5a50513          	add	a0,a0,-1446 # 8170 <malloc+0x211c>
    571e:	00001097          	auipc	ra,0x1
    5722:	87e080e7          	jalr	-1922(ra) # 5f9c <printf>
        exit(1);
    5726:	4505                	li	a0,1
    ...
    573a:	9fa50513          	add	a0,a0,-1542 # 8130 <malloc+0x20dc>
    573e:	00001097          	auipc	ra,0x1
    5742:	85e080e7          	jalr	-1954(ra) # 5f9c <printf>
    exit(1);
    5746:	4505                	li	a0,1
    ...
    575a:	9fa50513          	add	a0,a0,-1542 # 8150 <malloc+0x20fc>
    575e:	00001097          	auipc	ra,0x1
    5762:	83e080e7          	jalr	-1986(ra) # 5f9c <printf>
    exit(1);
    5766:	4505                	li	a0,1
  ...
  while(1){
    ...
    57ae:	9e650513          	add	a0,a0,-1562 # 8190 <malloc+0x213c>
    57b2:	00000097          	auipc	ra,0x0
    57b6:	7ea080e7          	jalr	2026(ra) # 5f9c <printf>
      exit(1);
    57ba:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    580c:	9a8b8b93          	add	s7,s7,-1624 # 81b0 <malloc+0x215c>
    int free0 = countfree();
    int free1 = 0;
    ...
    5826:	9a6d0d13          	add	s10,s10,-1626 # 81c8 <malloc+0x2174>
          return 1;
        }
      }
    }
    ...
    582e:	9bec8c93          	add	s9,s9,-1602 # 81e8 <malloc+0x2194>
    5832:	a839                	j	5850 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    5834:	856a                	mv	a0,s10
    5836:	00000097          	auipc	ra,0x0
    583a:	766080e7          	jalr	1894(ra) # 5f9c <printf>
    ...
    5856:	74a080e7          	jalr	1866(ra) # 5f9c <printf>
    int free0 = countfree();
    ...
    58a2:	6fe080e7          	jalr	1790(ra) # 5f9c <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    590a:	91258593          	add	a1,a1,-1774 # 8218 <malloc+0x21c4>
  ...
  char *justone = 0;
    ...
    5928:	8fc58593          	add	a1,a1,-1796 # 8220 <malloc+0x21cc>
    ...
    593e:	93658593          	add	a1,a1,-1738 # 8270 <malloc+0x221c>
  ...
  int continuous = 0;
    ...
    596a:	8c250513          	add	a0,a0,-1854 # 8228 <malloc+0x21d4>
    596e:	00000097          	auipc	ra,0x0
    5972:	62e080e7          	jalr	1582(ra) # 5f9c <printf>
    exit(1);
    5976:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5990:	8cc50513          	add	a0,a0,-1844 # 8258 <malloc+0x2204>
    5994:	00000097          	auipc	ra,0x0
    5998:	608080e7          	jalr	1544(ra) # 5f9c <printf>
  exit(0);
    599c:	4501                	li	a0,0
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5cea:	f66080e7          	jalr	-154(ra) # 5c4c <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60fe:	bba080e7          	jalr	-1094(ra) # 5cb4 <sbrk>
  if(p == (char*)-1)
