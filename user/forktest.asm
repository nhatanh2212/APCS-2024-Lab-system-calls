...
forktest(void)
{
  ...
  3e:	40e50513          	add	a0,a0,1038 # 448 <sysinfo+0xc>
  ...
  68:	43450513          	add	a0,a0,1076 # 498 <sysinfo+0x5c>
  ...
  8a:	3d250513          	add	a0,a0,978 # 458 <sysinfo+0x1c>
  ...
  a4:	3d050513          	add	a0,a0,976 # 470 <sysinfo+0x34>
  ...
  e4:	3a850513          	add	a0,a0,936 # 488 <sysinfo+0x4c>
